var VENDER_PREFIX=function(){var a=navigator.userAgent;return-1!=a.indexOf("Opera")?"O":-1!=a.indexOf("MSIE")?"ms":-1!=a.indexOf("WebKit")?"webkit":"Gecko"==navigator.product?"Moz":""}();function Basic(){}Basic.init=function(a){Basic.SetterAndGetterEscape.prototype={};var b=new Basic,c;for(c in b)a.__proto__[c]=b[c];b=a.__proto__;for(c in b);return a};
...
Sprite.prototype={__onEnterFrame__:function(){var a=this;this._nID=setInterval(function(){a.onEnterFrame()},1E3/stage.fps)},onEnterFrame:function(){null!=this._scene?this.dispatchEvent(this._scene.ENTER_FRAME):this.dispatchEvent("enterframe")},mask:{get:function(){return this._mask},set:function(a){this._image?a?(this._style[VENDER_PREFIX+"MaskImage"]="url("+this._image.src+")",this._style.backgroundImage="none"):(this._style[VENDER_PREFIX+"MaskImage"]="none",this._style.backgroundImage="url("+this._image.src+
...
TextField.prototype={text:{get:function(){this._text||(this._text="");return this._text},set:function(a){this._text=a;this._element.innerHTML=a}},selectable:{get:function(){this._selectable||(this._selectable=!1);return this._selectable},set:function(a){this._selectable=a;this._style[VENDER_PREFIX+"UserSelect"]=a?"text":"none"}}};
